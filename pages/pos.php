    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Categoria de producto</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="#motherboard" data-toggle="tab">Tarjeta madre</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#processor" data-toggle="tab">Procesador</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#powersupply" data-toggle="tab">Fuente de poder</a>
                              </li>
                              <li class="nav-item">
